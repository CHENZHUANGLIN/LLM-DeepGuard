...
from trl.trainer.grpo_trainer import (Any, AutoModelForSequenceClassification, AutoProcessor, AutoTokenizer, BaseTrainer, Callable, DataLoader, Dataset, FSDP, GRPOConfig, GRPOTrainer, GenerationConfig, IterableDataset, Path, PeftConfig, PeftModel, PreTrainedModel, PreTrainedTokenizerBase, ProcessorMixin, RepeatSampler, RewardFunc, RolloutFunc, Sampler, SyncRefModelCallback, TrainerCallback, VLLMClient, Version, _ForwardRedirection, add_response_schema, apply_chat_template, bnb, broadcast_object_list, copy, create_model_from_path, datasets, defaultdict, deque, disable_dropout_in_model, disable_gradient_checkpointing, ensure_master_addr_port, entropy_from_logits, gather, gather_object, get_config_model_id, get_peft_model, get_training_chat_template, identity, inspect, is_bitsandbytes_available, is_conversational, is_datasets_available, is_jmespath_available, is_liger_kernel_available, is_peft_available, is_peft_model, is_rich_available, is_vllm_available, json, logger, logging, nanmax, nanmin, nanstd, nn, nullcontext, os, pad, parse_response, partial, pd, prepare_deepspeed, prepare_fsdp, prepare_multimodal_messages, prepare_multimodal_messages_vllm, print_prompt_completions_sample, profiling_context, profiling_decorator, seed_worker, selective_log_softmax, set_seed, shuffle_sequence_dict, split_pixel_values_by_grid, split_tensor_dict, textwrap, time, torch, transformers, unsplit_pixel_values_by_grid, unwrap_model_for_generation, warnings, Any, apply_chat_template, disable_gradient_checkpointing, gather, gather_object, logging, nanmax, nanmin, nanstd, os, pad, pd, prepare_multimodal_messages, torch, FSDP, apply_chat_template, broadcast_object_list, copy, gather, gather_object, is_conversational, json, nullcontext, os, pad, pd, prepare_multimodal_messages, prepare_multimodal_messages_vllm, profiling_context, time, torch, transformers, unwrap_model_for_generation, entropy_from_logits, os, pad, selective_log_softmax, torch, transformers, Any, profiling_decorator, shuffle_sequence_dict, split_pixel_values_by_grid, split_tensor_dict, torch, unsplit_pixel_values_by_grid, PeftModel, PreTrainedModel, is_peft_available, logger, os, torch, FSDP, nn, os, pd, FSDP, is_peft_model, nn, pd, torch, GRPOTrainer, gather, os, torch)
